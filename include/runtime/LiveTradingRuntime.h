...
private:
    ...
    struct LiveSignalFunnelTelemetry {
        ...
        long long phase4_rejected_by_cluster_cap = 0;
        long long phase4_rejected_by_correlation_penalty = 0;
        long long phase4_rejected_by_execution_cap = 0;
        long long phase4_rejected_by_drawdown_governor = 0;
        long long phase4_candidate_snapshot_rows = 0;
        ...
        int phase4_allocator_top_k = 0;
        double phase4_allocator_min_score = 0.0;
        double phase4_risk_budget_per_market_cap = 0.0;
        double phase4_risk_budget_gross_cap = 0.0;
        double phase4_risk_budget_cap = 0.0;
        std::map<std::string, double> phase4_risk_budget_regime_multipliers;
        long long phase4_regime_budget_multiplier_applied_count = 0;
        std::map<std::string, long long> phase4_regime_budget_multiplier_count_by_regime;
        std::map<std::string, double> phase4_regime_budget_multiplier_sum_by_regime;
        double phase4_drawdown_current = 0.0;
        double phase4_drawdown_budget_multiplier = 1.0;
        double phase4_correlation_default_cluster_cap = 0.0;
        int phase4_correlation_market_cluster_count = 0;
        double phase4_execution_liquidity_low_threshold = 0.0;
        double phase4_execution_liquidity_mid_threshold = 0.0;
        double phase4_execution_min_position_size = 0.0;
