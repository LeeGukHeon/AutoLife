...
PolicyLearningPlaneAdapter::PolicyLearningPlaneAdapter(
...
void PolicyLearningPlaneAdapter::setPerformanceStore(
    const engine::PerformanceStore* performance_store
) {
    performance_store_ = performance_store;
}

PolicyDecisionBatch PolicyLearningPlaneAdapter::selectCandidates(
