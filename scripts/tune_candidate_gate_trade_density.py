...
def main() -> int:
    ...
    parser.add_argument("--build-config-path", default=r".\build\Release\config\config.json")
    parser.add_argument("--data-dir", default=r".\data\backtest")
    parser.add_argument("--curated-data-dir", default=r".\data\backtest_curated")
    parser.add_argument("--extra-data-dirs", nargs="*", default=[r".\data\backtest_real"])
    parser.add_argument("--output-dir", default=r".\build\Release\logs")
    parser.add_argument("--summary-csv", default=r".\build\Release\logs\candidate_trade_density_tuning_summary.csv")
    parser.add_argument("--summary-json", default=r".\build\Release\logs\candidate_trade_density_tuning_summary.json")
    parser.add_argument("--scenario-mode", choices=["legacy_only", "diverse_light", "diverse_wide", "quality_focus"], default="legacy_only")
    parser.add_argument("--max-scenarios", type=int, default=0)
    parser.add_argument("--include-legacy-scenarios", action="store_true")
